...
class TanhGaussianPolicy(Mlp, ExplorationPolicy):
    ...
    def get_actions(self, obs, deterministic=False):
        ...
        # print('part1',start.elapsed_time(end))
...
class MakeDeterministic(Wrapper, Policy):
    ...
    def get_action(self, observation,ids=None):
        if ids is None:
            return self.stochastic_policy.get_action(observation,
                                                 deterministic=True)
        else:
            return self.stochastic_policy.get_action(observation,
                                                 deterministic=True,ids=ids)

    def get_actions(self, observations,ids=None):
        if ids is None:
...
class TanhGaussianPolicyTest(Mlp, ExplorationPolicy):
    """
    Usage:
